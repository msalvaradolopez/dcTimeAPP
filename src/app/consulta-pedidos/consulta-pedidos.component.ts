...
export class ConsultaPedidosComponent implements OnInit {
  ...
  getIndicadores() {
    ...
    .subscribe(x => {
      ...
      this.conPorSurtidorList = x;
        this._servicios.wsGeneral("getConByPedidos", {claUN: "ALT", annio: this.annioSelected, mes: this.mesSelected, diasList: diasList, surtidoresList: surtidoresList})
        .subscribe(x => {
  ...
  getConsulta() {
    ...
    this._servicios.wsGeneral("getConByPedidos", {claUN: "ALT", annio: this.annioSelected, mes: this.mesSelected, diasList: dias, surtidoresList: surtidores})
    .subscribe(x => {
    this.conGeneralList = x;
